import { Card, CardBody, CardHeader, Drawer, Typography } from "@material-tailwind/react";
...
export default function AboutMe(){
    ...
    if(path === "/english"){
        return <section id="aboutMe" className="flex flex-col items-center pt-12 bg-gray-100">
        <div>
            <h1 className="font-bold text-4xl">About me</h1>
        </div>

        
        <div className="grid grid-cols-1 gap-4 pt-6  md:grid-cols-2 pl-24 pr-24 pb-52">
            <Card className="pt-4 ">
...
I perform excellently working in teams that approach problems intelligently and empathetically, taking everyone's opinions into account.
            ...
            <Card className="pt-4 ">
                <CardHeader className="font-bold text-center text-lg">Technologies</CardHeader>
                <CardBody className="grid grid-cols-3 gap-2 font-semibold text-md">
                    <div>
                    ...
                    <div className="pt-8">
                        <button className="font-semibold underline" onClick={(e)=> setOpenDrawer(true)}>... Among others!</button>
                    </div>
                </CardBody>
            </Card>
            <Card className="pt-4 ">
                <CardHeader className="font-bold text-center text-lg">Estudies and Formation</CardHeader>
                <CardBody className="font-semibold text-md">
I have completed formal studies in Systems Engineering at Santa María University. In addition, I took different courses on the Udemy platform, such as <Link href={"https://www.udemy.com/course/master-en-react-aprender-reactjs-hooks-mern-nodejs-jwt/"}>Master en React: Aprender ReactJS, Hooks, MERN, NodeJS, JWT+ </Link>
                o <Link href={"https://www.udemy.com/course/nextjs-react-the-complete-guide/"}>Next.js 14 & React - The Complete Guide</Link>, as well as a deep self-taught education in web development technologies that I am passionate about.</CardBody>
            </Card>
            <Card className="pt-4">
        ...
        <Drawer placement="bottom" open={openDrawer} onClose={() => setOpenDrawer(false)} className="p-4">
            ...
            <div className="flex justify-center gap-6">
                <div className="flex">
                    ...
                    </svg> <p className="pt-10 pl-4">MySQL</p>
                </div>
                <div className="flex">
                    ...
                    </svg> <p className="pt-10 pl-4">Java</p>
                </div>
                <div className="flex">
                    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0 0 48 48">
                    ...
                    </svg> <p className="pt-10 pl-4">Spring</p>
                </div>
            </div>
        </Drawer>
    </section>
    ...
    return <section id="aboutMe" className="flex flex-col items-center pt-12 bg-gray-100">
        ...
        <div className="grid grid-cols-1 gap-4 pt-6  md:grid-cols-2 pl-24 pr-24 pb-52">
            <Card className="pt-4 ">
                <CardHeader className="font-bold text-center text-lg">Un poco más de mí</CardHeader>
                <CardBody className="font-semibold text-md">
                    Tengo 22 años, mis hobbies son los videojuegos y la música. Me considero una persona responsable, y capaz de afrontar retos que desafien mis conocimientos. Me desenvuelvo excelentemente trabajando en equipos que aborden los problemas de forma inteligente y empática, tomando en cuenta las opiniones de todos.
                </CardBody>
            </Card>
            <Card className="pt-4 ">
                <CardHeader className="font-bold text-center text-lg">Tecnologías</CardHeader>
                <CardBody className="grid grid-cols-3 gap-2 font-semibold text-md">
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="50" height="50" viewBox="0 0 48 48">
                        <path fill="#E65100" d="M41,5H7l3,34l14,4l14-4L41,5L41,5z"></path><path fill="#FF6D00" d="M24 8L24 39.9 35.2 36.7 37.7 8z"></path><path fill="#FFF" d="M24,25v-4h8.6l-0.7,11.5L24,35.1v-4.2l4.1-1.4l0.3-4.5H24z M32.9,17l0.3-4H24v4H32.9z"></path><path fill="#EEE" d="M24,30.9v4.2l-7.9-2.6L15.7,27h4l0.2,2.5L24,30.9z M19.1,17H24v-4h-9.1l0.7,12H24v-4h-4.6L19.1,17z"></path>
                    ...
                    <div className="pt-8">
                        <button className="font-semibold underline">... Entre otras!</button>
                    </div>
                </CardBody>
            </Card>
            <Card className="pt-4 ">
                <CardHeader className="font-bold text-center text-lg">Estudios y formación</CardHeader>
                <CardBody className="font-semibold text-md">Tengo estudios formales finalizados de Ingeniería de Sistemas en la Universidad Santa María. Además, he realizado distintos cursos en la plataforma Udemy, como <Link href={"https://www.udemy.com/course/master-en-react-aprender-reactjs-hooks-mern-nodejs-jwt/"}>Master en React: Aprender ReactJS, Hooks, MERN, NodeJS, JWT+ </Link>
                o <Link href={"https://www.udemy.com/course/nextjs-react-the-complete-guide/"}>Next.js 14 & React - The Complete Guide</Link>, así como una profunda educación autodidacta en tecnologías de desarrollo web que me apasionan.</CardBody>
            </Card>
            <Card className="pt-4">
